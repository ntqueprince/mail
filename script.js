...
categoryEl.addEventListener('change', ()=>{
  ...
  previewHeader.className = 'previewHeader previewHeader'; 
  ...
  mailDateRow.style.display = 'block'; 
...
We appreciate your patience in the interim.`;
    ...
    case 'refund_success': {
      ...
      const amountStr = amount!==null ? `Rs.${new Intl.NumberFormat('en-IN').format(amount)}/-` : 'Rs.6597/-';
      const dateString = rDateStr ? rDateStr.toUpperCase().replace(/\s/g, ' ') : '11 SEP 2025';
...
We would like to inform you that a refund of ${amountStr} has been processed in your a/c on the date of ${dateString} by the Insurance co., and same shall be credited in 7 working days.

We request you to contact your respective bank if the refund doesn't reflect in your bank account/wallet automatically within 7 working days from the date of refund process.`;
      break;
    }
...
We would like to apprise you that we shall share an update with you by ${tat} on your query.
